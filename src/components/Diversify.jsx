...
const Diversify = () => {
  ...
  return (
    <div className='mt-20 max-w-[1150px] mx-auto p-10 border border-dashed rounded-3xl'>
      <div className='flex justify-between border-b pb-10 gap-14'>
        <h2 className='text-5xl font-semibold'> <span className='text-primary-red' >Diversify your asset portfolio</span>  by investing in multiple properties.</h2>
