    ...
    <div>
        ...
        <div className='about max-w-[1300px] px-5 sm:px-10 mx-auto mt-12' >
            <div className="text-center">
                <h1 className='custom-title text-3xl sm:text-7xl tracking-tight font-semibold' >{blog.title}</h1>
            </div>
            <div className="grid my-20 gap-16 mx-auto w-full">
               ...
               <span className='custom-title' >  {blog.author}</span> <span>{blog.date}</span>
                </p>
